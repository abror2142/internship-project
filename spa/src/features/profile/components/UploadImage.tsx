...
function UploadImage () {
    ...
    return (
        <div className="relative "> 
            <label 
                className="flex gap-2 items-center px-4 py-1.5 dark:bg-dark-blue dark:hover:bg-blue-950
                    max-w-min rounded-md border dark:border-dark-border"
